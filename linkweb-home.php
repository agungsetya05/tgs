...
<body>
   <div id="layout">
	...
	<div id="isi">
		...
		<h1>LINK WEBSITE TERKAIT DENGAN<br>
			SMK NEGERI 7 SEMARANG</h1><br>
			<hr>
			<p align="center">
			<img src="stemba.jpg" width="40%" height="250px"><br></p>
			<p align="center">
			1.Website Dinas Pendidikan Nasional<br>
			<a href="https://www.kemdikbud.go.id/">Klik Disini!!!</a><br>
			2.Website Smk Negeri 7 Semarang<br>
			<a href="http://web.smkn7semarang.sch.id">Klik Disini!!!</a><br>
			<br></p>
